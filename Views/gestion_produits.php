  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class=""></i> Gestion des produits</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i>Dashboard</li>
              <li><i class="icon_desktop"></i>Produits</li>
            ...
            <div class="modal-body">
              ...
              <form class="form-horizontal" role="form">
                <div class="form-group">
                  <label for="inputEmail1" class="col-lg-3 control-label">Nom du produit</label>
                  <div class="col-lg-9">
                    <input type="email" class="form-control" id="inputEmail1" placeholder="Nom du produit">
              ...
              <div class="form-group">
                  <label for="inputPassword1" class="col-lg-3 control-label">Description</label>
                  <div class="col-lg-9">
                  <textarea class="form-control" name="message" 
                  rows="5" data-rule="required"  placeholder="Message"> </textarea>
                  </div>
              </div>
